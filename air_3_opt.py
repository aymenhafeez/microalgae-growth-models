...
data = pd.read_csv(
    '/Users/AymenHafeez/Desktop/DESKTOP/Research_project/Microalgae_Models/data_air.csv')
...
plt.plot(t1, xi[:, 0], 'g--', label='Initial prediction')
plt.plot(t1, xi[:, 1], 'r-', label='Optimised model')
plt.ylabel('Biomass concentration (g L$^{-1}$)', fontsize=15)
