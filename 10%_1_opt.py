...
data = pd.read_csv(
    '/Users/AymenHafeez/Desktop/DESKTOP/Research_project/Microalgae_Models/data_3.1.csv')
...
plt.plot(t1, X1meas, '.', markersize=12, markerfacecolor='w',
         markeredgecolor='b', markeredgewidth=0.5, label='Experimental data')
