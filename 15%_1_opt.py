...
data = pd.read_csv(
    '/Users/AymenHafeez/Desktop/DESKTOP/uni_stuff/Research_project/Microalgae_Models/data_4.15.csv')
...
plt.plot(t1, X1meas, '.', markersize=12, markerfacecolor='w',
         markeredgecolor='b', markeredgewidth=1, label='Measured data')
plt.plot(t1, xi[:, 0], 'g--', linewidth=2, label='Initial prediction')
plt.plot(t1, xi[:, 1], 'r-', linewidth=2, label='Optimised model')
